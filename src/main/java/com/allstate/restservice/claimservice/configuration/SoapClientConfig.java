package com.allstate.restservice.claimservice.configuration;
...
public class SoapClientConfig {
    ...
    public WebServiceTemplate webServiceTemplate(SaajSoapMessageFactory messageFactory,
        ...
        webServiceTemplate.setDefaultUri("http://localhost:8082/ws"); // SOAP service endpoint URL
    ...
    public Jaxb2Marshaller jaxb2Marshaller() {
        ...
        marshaller.setContextPath("com.allstate.claim"); // Set the package where your generated JAXB classes are located
        return marshaller;
    }
